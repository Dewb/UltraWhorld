...
static CFFGLPluginInfo PluginInfo(
                                  ...
                                  "by Chris Korda; experimental x64 FFGL port by Dewb", // About
                                  0,
                                  NULL
);
...
FFResult UltraWhorldFFGL::DeInitGL()
{
    return FF_SUCCESS;
}

FFResult UltraWhorldFFGL::ProcessOpenGL(ProcessOpenGLStruct *pGL)
{
...
float UltraWhorldFFGL::GetFloatParameter(unsigned int index)
{
...
FFResult UltraWhorldFFGL::SetFloatParameter(unsigned int index, float val)
{
    if (index >= 0 && index < NUM_PARAMS) {
